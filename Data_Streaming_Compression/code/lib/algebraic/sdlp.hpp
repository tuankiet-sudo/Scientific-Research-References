 ...
 *
 * Src: https://github.com/ZJU-FAST-Lab/SDLP
 */
...
namespace sdlp
{
    ...
    inline bool unit(int d, double *a)
    {
        double mag = 0.0;
        for (int i = 0; i <= d; i++)
        {
    ...
    inline int lp_no_con(int d, const double *n_vec,
                         const double *d_vec,
                         double *opt)
    {
        double n_dot_d = 0.0;
    ...
    inline void findimax(int d, const double *pln,
                         int *imax)
    {
        *imax = 0;
    ...
    inline void vector_up(int d, const double *equation,
                          const int ivar,
    ...
    inline void vector_down(int d, const double *elim_eqn,
                            const int ivar,
    ...
    inline void plane_down(int d, const double *elim_eqn,
                           const int ivar,
    ...
    inline int linfracprog(int d, const double *halves, /* halves  --- half spaces */
    ...
    */
    {
        ...
        Eigen::VectorXd opt(d + 1);
        Eigen::MatrixXd halves(d + 1, m);
